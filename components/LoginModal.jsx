...
const LoginModal = () => {
    ...
    return (
        <>
            <Button type='button' title="Login" buttonStyle="orange" onClick={openModal}/>
            {modalIsOpen &&             
            <Modal 
            isOpen={modalIsOpen} 
            ...
            >
                <div className='scroll-component'>
                    ...
                    <h2 className={styles.h2Style}>Логин</h2>
                    <form className='loginForm flex flex-col gap-[22px]' onSubmit={(e) => sendLogin(e)}>  
                        <label htmlFor="number" className={styles.label}>
                            <span className={styles.labelSpan}>Ваш телефон</span>
                            <input 
                            name='mail'
                            value={form.mail}
                        ...
                        <Button type='submit' title="Войти" buttonStyle="orange"/>
                    </form>
                </div>
            </Modal>
            }
